...
wordcloud_df = pd.DataFrame({
    "word": [
        "護國神山", "營收新高", "外資調節", "資本支出", "先進製程",
        "法說看好", "短線獲利", "多頭重啟", "高殖利率", "散戶進場",
        "供應鏈", "融資增加", "大盤回檔", "主力倒貨", "追高套牢"
    ],
    "count": [152, 110, 88, 75, 68, 54, 48, 42, 36, 32, 28, 24, 20, 18, 14],
    "sentiment": [+0.85, +0.92, -0.45, +0.60, +0.75, +0.80, -0.30, +0.70, +0.40, -0.50, +0.30, -0.60, -0.70, -0.85, -0.90]
})
...
# =========================================================
with tab_wordcloud:
    st.subheader("PTT 股市版熱議關鍵詞向量星系 (字體大小=詞頻, 顏色=情緒極性)")
